...
require_once 'database/clean_database.php';
...
// Wywołanie funkcji do czyszczenia bazy danych
cleanOldTransports();
// Wywołanie funkcji do zapisu danych do bazy
seedDatabaseWithTransports($firmaoDataWithDistances);

// Zatrzymanie dalszego wykonywania skryptu
